...
public:
    ...
    void execute(cv::Mat master_mat, cv::Mat slave_mat, ossimStereoPair StereoPair, int rows, int cols, double currentRes, ossimImageHandler *master_handler, int ndisparities, int minimumDisp, int SADWindowSize);
    cv::Mat getDisp();
